...
def plot_cov(en_scores, ma_scores, plot_squares=False):
    ...
    ax.set_xlim(*x_range)
    ax.set_ylim(*y_range)
    ax.set_xlabel('英语的分数', fontsize=16)
    ax.set_ylabel('数学的分数', fontsize=16)
...
def plot_cov_interact(en_scores, ma_scores):
    ...
    @interact(A同学的英语=x_range, A同学的数学=y_range,
              B同学的英语=x_range, B同学的数学=y_range,
              C同学的英语=x_range, C同学的数学=y_range,
              D同学的英语=x_range, D同学的数学=y_range)
    def plot(A同学的英语=en_scores[0], A同学的数学=ma_scores[0],
             B同学的英语=en_scores[1], B同学的数学=ma_scores[1],
             C同学的英语=en_scores[2], C同学的数学=ma_scores[2],
             D同学的英语=en_scores[3], D同学的数学=ma_scores[3]):
        fig = plt.figure(figsize=(10, 10))
        ax = fig.add_subplot(111)
        ax.grid(False)

        names = ['A', 'B', 'C', 'D']
        en_scores = [A同学的英语, B同学的英语, C同学的英语, D同学的英语]
        ma_scores = [A同学的数学, B同学的数学, C同学的数学, D同学的数学]
        en_mean = np.mean(en_scores)
        ma_mean = np.mean(ma_scores)
